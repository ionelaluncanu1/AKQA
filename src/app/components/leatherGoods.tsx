    ...
    <div>
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl py-20 sm:py-24 lg:max-w-none">
          <h2 className="text-3xl">Leather Goods</h2>

          <div className="mt-8 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
            {data.leatherGoods.map((item) => {
              return (
                <div className="group relative" key={item.id}>
                  <div className="relative w-full overflow-hidden rounded-lg bg-white sm:aspect-square lg:aspect-auto group-hover:opacity-75">
                    <Image
                      src={item.url}
                      alt=""
